...
release_all_clients: ## Release all Clients of S2T
	@make release_python_client || (echo "Already released ${ONDEWO_S2T_API_VERSION} of Python Client")
	@make release_nodejs_client || (echo "Already released ${ONDEWO_S2T_API_VERSION} of Nodejs Client")
	@make release_typescript_client || (echo "Already released ${ONDEWO_S2T_API_VERSION} of Typescript Client")
	@make release_angular_client || (echo "Already released ${ONDEWO_S2T_API_VERSION} of Angular Client")
	@make release_js_client || (echo "Already released ${ONDEWO_S2T_API_VERSION} of JS Client")
